...
class MultiAgentReplayBuffer:
    ...
    def sample_buffer(self):
        ...
        # actor_states = np.asarray(actor_states).transpose(1, 0, 2)
        states = np.concatenate(actor_states, axis=1)
        states_ = np.concatenate(actor_new_states, axis=1)
        # actor_new_states = np.asarray(actor_new_states)
